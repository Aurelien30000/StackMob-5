...
public class Commands implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] strings) {
        ...
        if (strings.length == 0) {
            ...
            for (SubCommand subCommand : subCommands) {
                ...
                final String cmd = sm.getServer().getPluginCommand("sm").getPlugin().equals(sm) ? "sm" : "stackmob";
    ...
    public List<String> onTabComplete(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] strings) {
        if (strings.length == 1) {
            ...
            for (SubCommand subCommand : subCommands) {
                final String commandString = subCommand.getCommand();
        ...
        for (SubCommand subCommand : subCommands) {
            ...
            final CommandArgument commandArgument = subCommand.getArguments()[strings.length - 2];
            final List<String> expectedArguments = new LinkedList<>(commandArgument.getExpectedArguments());
